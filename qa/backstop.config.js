  ...
  scenarios: [
    {
      ...
      selectors: ['document', '.hero-section', '.featured-artifacts', '.navigation'],
    ...
    },
    {
      ...
      delay: 2000,
      selectors: ['document', '.hero-section', '.mission-statement', '.team-section'],
      misMatchThreshold: 0.1,
    },
    {
      ...
      delay: 3000,
      selectors: ['document', '.artifact-grid', '.filter-sidebar', '.artifact-card'],
      misMatchThreshold: 0.1,
    },
    {
      ...
      delay: 2000,
      selectors: ['document', '.portfolio-header', '.owned-artifacts', '.fractional-shares'],
      misMatchThreshold: 0.1,
    },
    {
      ...
      selectors: ['.wallet-modal', '.wallet-options'],
