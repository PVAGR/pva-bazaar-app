...
### Added
- DOCX and PDF manuscript upload support in the book publishing workspace, with server-side text extraction, a visible mobile-friendly browse button plus file control, and binary-file handling that skips the client text editor until save.
