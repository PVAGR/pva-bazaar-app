    ...
    <section className="flex flex-col gap-10">
      <header className="space-y-3">
        ...
        <h1 className="text-2xl md:text-3xl font-semibold text-zinc-100">
          Home Station Protocol
        </h1>
        <p className="max-w-xl text-sm text-zinc-400">
          A fragment of how we frame origin, scarcity, and acquisition. Anchored
          in Pasha VII – Moon 3 – Royal Amarr Institute School.
        </p>
      </header>

      <article className="rounded-xl border border-zinc-800/80 bg-zinc-950/60 p-6 space-y-4">
        <p className="text-sm text-zinc-300 leading-relaxed">
          Pasha VII – Moon 3 is where most pilots remember <em>learning the
          interface</em> but forget learning themselves.
        </p>
        <p className="text-sm text-zinc-300 leading-relaxed">
          When you <strong>initiate acquisition</strong>, you’re not buying
          nostalgia. You’re claiming a teaching tool from a specific orbit in
          time: Pasha VII – Moon 3, where the idea of “home station” first
          wrapped itself around your spine.
        </p>
        <p className="text-sm text-zinc-300 leading-relaxed">
          We preserve artifacts – digital and physical – as evidence that a
          human hand was here. Hashes, provenance, and story stay on the
          record. No cinematic upgrades, no DRM scarring. All systems aim to be
          auditable, anti-Druj, and kind to future readers.
        </p>
