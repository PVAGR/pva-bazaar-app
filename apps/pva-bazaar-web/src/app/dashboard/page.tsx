  ...
  return (
    <section className="flex flex-col gap-10">
      <header className="space-y-3">
        ...
        <h1 className="text-2xl md:text-3xl font-semibold text-zinc-100">My artifacts</h1>
        <p className="max-w-xl text-sm text-zinc-400">
          Enter one or more artifact IDs (one per line or comma-separated) to see verification
          status for each. No sign-in for this MVP; you provide the IDs you care about.
        </p>
      </header>

      <form onSubmit={handleLookup} className="space-y-4">
        <label className="block text-xs font-medium text-zinc-400">Artifact IDs</label>
        <textarea
          value={idsInput}
