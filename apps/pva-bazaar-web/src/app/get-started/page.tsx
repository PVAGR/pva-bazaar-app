...
const PATH_OPTIONS = [
  ...
  },
  {
    title: 'Consumer',
    summary:
      'Collect verified artifacts and follow creators across archive and marketplace layers.',
  },
  {
    ...
    <section className="flex w-full flex-col gap-10">
      <header className="grid gap-6 rounded-xl border border-zinc-800/80 bg-zinc-950/60 p-6 lg:grid-cols-[1.2fr_1fr]">
        <div className="space-y-4">
          ...
          <p className="max-w-3xl text-sm leading-7 text-zinc-300">
            This page is now the first impression for the sanctuary layer. Learn each tab quickly,
            choose your federation path, and continue to account setup and identity steps.
          </p>
        ...
        <aside
          className="space-y-3 rounded-xl border border-zinc-800/80 bg-black/40 p-4"
          aria-label="Account entry"
        >
          <h2 className="text-base font-semibold text-zinc-100">Create your account</h2>
          <p className="text-sm leading-6 text-zinc-300">
            Account creation currently runs on the main federation app. After joining, continue into
            role setup, wallet connection or generation, and optional DID/IPFS onboarding.
          </p>
          <a
          ...
          <p className="text-xs text-zinc-500">
            Set NEXT_PUBLIC_MAIN_APP_REGISTER_URL to override this destination.
          </p>
        </aside>
      </header>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-zinc-400">
          Primary surfaces for archive, verification, and guiding context.
        </p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-zinc-400">
          Use these as your operational layer once your profile path is defined.
        </p>
        <div className="grid gap-4 md:grid-cols-3">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-zinc-400">
          These are the role tracks that your onboarding flow will support.
        </p>
