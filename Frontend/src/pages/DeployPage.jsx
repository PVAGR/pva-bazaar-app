...
export default function DeployPage() {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ margin: '0 0 8px', fontSize: '28px', fontWeight: '800' }}>Deploy Your Own PVA Bazaar</h1>
        <p style={{ margin: '0 0 4px', fontSize: '16px', color: 'var(--site-text-muted)' }}>
          Launch a self-governing community instance in minutes with no code required.
        </p>
        <p
          style={{
            margin: '12px 0 0',
      ...
      >
        <h2 style={{ margin: '0 0 16px', fontSize: '20px' }}>Configuration Options</h2>
      ...
      >
        <h2 style={{ margin: '0 0 16px', fontSize: '20px' }}>Join the Federation</h2>
