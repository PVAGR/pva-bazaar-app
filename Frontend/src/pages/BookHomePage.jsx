...
const BOOK_DATA = {
  ...
  chapters: [
    ...
    },
    {
      part: 'V',
      title: 'Humanity',
      chapters: ['Family', 'Clan', 'Community', 'Nation', 'Civilization', 'Humanity'],
    },
    {
      part: 'VI',
    ...
    },
    {
      ...
      title: 'The New Human',
      chapters: [
        'The Education of the New Human',
        'Profession',
        'Service',
        'Love',
        'Family: The First Commonwealth',
        'Mastery: The Discipline of the Gift',
        'Responsibility: The Weight of Receiving',
      ],
    },
    {
      part: 'VIII',
      ...
      chapters: [
        ...
        'The Sovereign Bazaar',
        'The Community Commonwealth',
        'Free Homes',
        'New Governance',
        'The Three Vote System',
        'Technology as Tool',
        'Living With Nature',
      ],
    },
    {
      ...
      chapters: [
        'Aether-Zamin',
        'The Universal Civilization: The Ordered Family of Peoples',
        'The Return of Purpose',
        'The Restoration of Asha',
        "God's World and Its Children",
        'Live Well',
      ],
    },
  ],
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read 'This or That' by Richard Torres — A profound book of teachings on purpose, choice, civilization, and the restoration of divine order. Free download available."
        />
        <meta property="og:title" content="This or That — A Book of Teachings" />
        <meta
          property="og:description"
          content="A profound exploration of human purpose, choice, and the architecture of civilization by Richard Torres."
        />
      ...
      <div className="book-home">
        ...
        <section className="section-card book-home__chapters">
          <div className="book-home__sectionHead">
            ...
            <button className="book-home__toggle" onClick={() => setShowChapters(!showChapters)}>
              {showChapters ? 'Collapse' : 'Expand'} Table of Contents
              <svg
                className={`icon ${showChapters ? 'rotated' : ''}`}
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
            ...
            <div className="book-home__toc">
              {BOOK_DATA.chapters.map((part) => (
                <div key={part.part} className="book-home__part">
                  <h3 className="book-home__partLabel">
        ...
        <section className="section-card book-home__support">
          ...
          <p>
            This book and the PVA Bazaar platform are sustained by readers like you. Every
            contribution keeps the work free, the platform sovereign, and the mission alive.
          </p>
        ...
        <section className="section-card book-home__marketplace">
          ...
          <p>
            Purchase a physical edition, merchandise, or gift a copy through the sovereign bazaar.
          </p>
        ...
        <footer className="book-home__footer">
          <p>
            Published by <strong>PVA Bazaar</strong> — A civilization platform for memory, trade,
            and accountable decisions.
          </p>
          <p>
            <a href="https://pvabazaar.org" target="_blank" rel="noreferrer">
              pvabazaar.org
            </a>
          </p>
              ...
              {downloadType === 'free' && (
                <div className="modal-free">
                  ...
                  <p className="modal-note">
                    If you value this work, consider supporting the mission.
                  </p>
                </div>
              )}
