...
const AdminTabs = React.memo(function AdminTabs({ activeTab, onTabChange }) {
  const tabs = [
    ...
    { id: 'library', label: '🧠 Knowledge Library', title: 'Manual and training archive (Alt+8)', shortcut: '8' },
    { id: 'api', label: '🔗 API Docs', title: 'API documentation & endpoints (Alt+9)', shortcut: '9' },
