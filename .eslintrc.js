    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'Do not use raw hex colors. Use brand tokens from your design system (e.g., Tailwind config or CSS variables). If you must use a hex code, it must be an official brand color.',
        },
