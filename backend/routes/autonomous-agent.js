 ...
 */
router.get(
  '/api/admin/autonomous-agent/status',
  requireAdmin,
  asyncHandler(async (req, res) => {
    let agent = await AutonomousAgent.findOne({});
 ...
 */
router.post(
  '/api/admin/autonomous-agent/:agentId/payment-method',
  requireAdmin,
  asyncHandler(async (req, res) => {
 ...
 */
router.post(
  '/api/admin/autonomous-agent/:agentId/billing-schedule',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
 ...
 */
router.post(
  '/api/admin/autonomous-agent/:agentId/toggle-operations',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
 ...
 */
router.post(
  '/api/admin/autonomous-agent/:agentId/fund',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
 ...
 */
router.post(
  '/api/admin/autonomous-agent/:agentId/execute-payments',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
 ...
 */
router.get(
  '/api/admin/autonomous-agent/:agentId/health',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
 ...
 */
router.get(
  '/api/admin/autonomous-agent/:agentId/payment-methods',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
 ...
 */
router.get(
  '/api/admin/autonomous-agent/:agentId/wallets',
  requireAdmin,
  asyncHandler(async (req, res) => {
    const agent = await AutonomousAgent.findById(req.params.agentId);
    if (!agent) return res.status(404).json({ error: 'Agent not found' });
