  ...
  try {
    ...
    if (onboardingProfile && typeof onboardingProfile === 'object') {
      ...
      if (onboardingProfile.roleOther !== undefined) {
        update['onboardingProfile.roleOther'] = String(onboardingProfile.roleOther || '').trim().slice(0, 120);
      }

      if (onboardingProfile.personalJourney !== undefined) {
        update['onboardingProfile.personalJourney'] = String(onboardingProfile.personalJourney || '').trim().slice(0, 5000);
      }
      ...
      if (onboardingProfile.emailPreferences && typeof onboardingProfile.emailPreferences === 'object') {
        if (onboardingProfile.emailPreferences.digestOptIn !== undefined) {
          update['onboardingProfile.emailPreferences.digestOptIn'] = Boolean(onboardingProfile.emailPreferences.digestOptIn);
        }
        if (onboardingProfile.emailPreferences.roleTrackUpdates !== undefined) {
          update['onboardingProfile.emailPreferences.roleTrackUpdates'] = Boolean(onboardingProfile.emailPreferences.roleTrackUpdates);
        }
      }
      ...
      if (onboardingProfile.identity && typeof onboardingProfile.identity === 'object') {
        ...
        if (identity.walletMode !== undefined) {
          const walletMode = String(identity.walletMode || '').trim().toLowerCase();
        ...
        if (identity.generatedWalletAddress !== undefined) {
          update['onboardingProfile.identity.generatedWalletAddress'] = cleanText(identity.generatedWalletAddress, 120);
        }
      ...
      if (onboardingProfile.contactLinks && typeof onboardingProfile.contactLinks === 'object') {
        if (onboardingProfile.contactLinks.instagram !== undefined) {
          update['onboardingProfile.contactLinks.instagram'] = cleanText(onboardingProfile.contactLinks.instagram, 120);
        }
        if (onboardingProfile.contactLinks.telegram !== undefined) {
          update['onboardingProfile.contactLinks.telegram'] = cleanText(onboardingProfile.contactLinks.telegram, 120);
        }
        if (onboardingProfile.contactLinks.website !== undefined) {
          update['onboardingProfile.contactLinks.website'] = cleanText(onboardingProfile.contactLinks.website, 300);
        }
        if (onboardingProfile.contactLinks.other !== undefined) {
          update['onboardingProfile.contactLinks.other'] = cleanText(onboardingProfile.contactLinks.other, 300);
        }
      }

      if (onboardingProfile.compliance && typeof onboardingProfile.compliance === 'object') {
        const compliance = onboardingProfile.compliance;
        if (compliance.legalFullName !== undefined) update['onboardingProfile.compliance.legalFullName'] = cleanText(compliance.legalFullName, 150);
        if (compliance.legalIdType !== undefined) update['onboardingProfile.compliance.legalIdType'] = cleanText(compliance.legalIdType, 80);
        if (compliance.legalIdNumber !== undefined) update['onboardingProfile.compliance.legalIdNumber'] = cleanText(compliance.legalIdNumber, 120);
        if (compliance.addressLine1 !== undefined) update['onboardingProfile.compliance.addressLine1'] = cleanText(compliance.addressLine1, 180);
        if (compliance.addressLine2 !== undefined) update['onboardingProfile.compliance.addressLine2'] = cleanText(compliance.addressLine2, 180);
        if (compliance.city !== undefined) update['onboardingProfile.compliance.city'] = cleanText(compliance.city, 120);
        if (compliance.stateProvince !== undefined) update['onboardingProfile.compliance.stateProvince'] = cleanText(compliance.stateProvince, 120);
        if (compliance.postalCode !== undefined) update['onboardingProfile.compliance.postalCode'] = cleanText(compliance.postalCode, 40);
        if (compliance.country !== undefined) update['onboardingProfile.compliance.country'] = cleanText(compliance.country, 120);
        if (compliance.phone !== undefined) update['onboardingProfile.compliance.phone'] = cleanText(compliance.phone, 40);
    ...
    if (user) {
      ...
      const communityFieldsTouched = updatedFields.some((field) =>
        field === 'onboardingProfile.personalJourney' || field === 'onboardingProfile.federationPathTags'
      );

      if (communityFieldsTouched) {
        dispatchToOpenClaw(createUserEvent('community_profile_saved', user, {
